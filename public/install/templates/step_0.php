...
<div class="mainBody">
    <div class="text">
        ...
        <p>尊敬的用户：</p>
        <div class="hr_8"></div>
        <p>感谢您选择星易采平台，希望我们的努力能为您提供一款适用于企业级电子采购管理系统。
        </p>
        <div class="hr_8"></div>
        <p>星易采平台（以下称“本平台”），由星易采自主研发，版权所有Copyright(c)2024，星易采保留所有权利。 使用者无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始 使用本系统。本授权协议适用且仅适用于本产品，星易采拥有对本授权协议的最终解释权。</p>
        <p>使用者无论个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，方可开始使用本系统。本授权协议适用且仅适用于本产品，星易采拥有对本授权协议的最终解释权。</p>
        <div class="hr_8"></div>
        ...
        <h4>三. 有限担保和免责声明</h4>
        <p>本系统及所附带的文件是作为不提供任何明确的或隐含的赔偿或担保的形式提供的。用户出于自愿而使用本系统，您必须了解使用本系统的风险，在尚未购买产品技术服务之前，我们不承诺提供任何形式的技术支持、使用担保，也不承担任何因使用本系统而产生问题的相关责任。星易采不对使用本系统构建的网站和应用中的内容或信息承担责任。</p>
        <div class="hr_8"></div>
        <p>本系统受著作权法、国际著作权条约和其他的知识产权法律或国际条约保护。根据本协议，在此仅许可您非独占性的、非排他性的一般许可使用该软件的权利，而不是出售或转让。</p>
        <div class="hr_8"></div>
        <p>有关本系统最终用户授权协议、商业授权与技术服务的详细内容，均由星易采官方网站独家提供。星易采拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议对自改变之日起的新授权用户生效。</p>
        <div class="hr_8"></div>
