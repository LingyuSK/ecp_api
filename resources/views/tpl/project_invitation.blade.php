<p>
	<p style="line-height: 2em; color: rgb(80, 80, 80); font-family: 微软雅黑, Arial; font-size: 14px;white-space: normal;">
		<span style="font-weight:800">
			致
		</span>
		:
		<span style="color:black;display: inline-block;font-weight:bold; ">
			{{$supplier_name}}
		</span>
	</p>
	...
	<p style="line-height: 30px;font-size: 14px;font-weight: normal;">
		...
		@if(!empty($supplier_deposit))
                ¥ {{number_format($supplier_deposit,2,'.',',')}}
